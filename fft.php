    ...
    do {
        ...
        for($i = 0; $i < count($listids); $i++):
            ...
            if($priv == 1):
                ...
                //comment media
                $listKomentar = array("Like back dan Follow back ya🙏", "follback dan like back🙏", "follback ya👌", "Like back dan Follow back ya🙏", " follback dan like back ya👍", "salam kenal follback dan likeback ya kak👍", "orang mana? follback dan likeback ya👍", "Like back dan Follow back ya🙏", " boleh minta follback dan likeback?", "follback yo", "follbackk", "followback ya", "udah aku follow dan like bisa minta follback dan likeback gak hehe", "follback dan likeback yo kak udah difollow kok", "follback dan likeback kak sudah aku follow dan like", "bisa minta follow back kak hehe?", "followback yo 😀", "Like back dan Follow back ya🙏", " follback ya 🙂 ", "Like back dan Follow back ya🙏", " follback aku yah", "Like back dan Follow back ya🙏", " btw follback ya", "Like back dan Follow back ya🙏", " follback juga yah hehe", "Like back dan Follow back ya🙏", " follback yah hehe", "bisa minta follback ?", "follback yow", "follback yapp", "Follback hihihihi", "follbackk saya ya 🙂", "Like back dan Follow back ya🙏", " like back dan Follback ya", "Salam kenal kak hehe likeback dan follback ya", "Salkus ya kak like back dan follback ya", "Like back dan Follow back ya🙏", "like back dan follback ya", "Like back dan Follow back ya🙏", " Salam kenal ya tod ", " likeback dan Follback yaa", "Orang mana kak?", " likeback dan Follback dong", "Like back dan Follow back ya🙏", " Salam kenal ya", " like back dan follback ya", "Saling follback ya kak", " Like back dan Follow back ya🙏", "Orang mana kak", " likeback dan Follbackdong hehehe", "Like back dan Follow back ya🙏", "", " like back dan Follback ya", "Mari berteman ya kak saling dan follback hehe", "Kenalan dong kak heheh likeback dan follback ya", "Likeback dan follback hihi salam kenal ya", "Hallo kak salam kenal ya hehe likeback dan follback juga ya");
